package lesson6.problem.taskb;

import lesson6.sort2.PersonData;
...
public class DeptEmployeeData {
	...
	static void main() {
		...
		//Sorting
		Arrays.sort(data, new DeptEmployeeData().getInner());
		System.out.println("After Sorting: " + Arrays.toString(data));
	}

	private class MyInnerComparator implements Comparator<DeptEmployee> {
	...
	public DeptEmployeeData.MyInnerComparator getInner(){
		return new DeptEmployeeData.MyInnerComparator();
	}
}
